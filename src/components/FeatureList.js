...
const featuresPartner = [{
	logo:'images/bcPartnerperCent.svg',
	title: `${t('Features.group_0_partner.title_1')}`,
	title1: `${t('Features.group_0_partner.title_2')}`,
	text: `${t('Features.group_0_partner.text_1')}`,
	text1: `${t('Features.group_0_partner.text_2')}`,
},
{
	logo:'images/realTimedata.svg',
	title: `${t('Features.group_2_partner.title_1')}`,
	title1: `${t('Features.group_2_partner.title_2')}`,
	text: `${t('Features.group_2_partner.text_1')}`,
	text1: `${t('Features.group_2_partner.text_2')}`,
	// title:'Realtime Data',
...
},
{
	...
	title: `${t('Features.group_3_partner.title_1')}`,
	title1: `${t('Features.group_3_partner.title_2')}`,
	text: `${t('Features.group_3_partner.text_1')}`,
	text1: `${t('Features.group_3_partner.text_2')}`,
