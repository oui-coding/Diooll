        ...
        <div className="pricing_all_item">
          <div className="pricing_ first_type">
            ...
            <div className="pricing_01">
              ...
              <p>
                <img className="checkIcon" alt="check_yes icon" src={require("../images/check_yes.svg")} /> {t('pricing.group.text_7')} <span style={{fontSize:'0.6vw',position: 'absolute'}}>  XAF </span> <span  style={{marginLeft:'5%'}}>1.000.000
